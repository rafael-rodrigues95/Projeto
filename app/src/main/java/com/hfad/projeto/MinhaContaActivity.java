...
public class MinhaContaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewHolder.bt_editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                long res = db.Utilizador_Delete(Integer.parseInt(mViewHolder.et_id.getText().toString()));
                if (res > 0) {
                    Toast.makeText(MinhaContaActivity.this, "Registro editado com sucesso", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(MinhaContaActivity.this, "Erro ao editar o registro", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mViewHolder.bt_remover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int id = Integer.parseInt(mViewHolder.et_id.getText().toString().trim());
                if (res > 0) {
                    Toast.makeText(MinhaContaActivity.this, "Registro eliminado com sucesso", Toast.LENGTH_SHORT).show();
                    PreencherListaUtilizadores();
                } else {
                    Toast.makeText(MinhaContaActivity.this, "Erro ao eliminar o registro", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void PreencherDadosUtilizador(int id) {
        ...
        mViewHolder.et_username.setText(String.valueOf(u.id));
